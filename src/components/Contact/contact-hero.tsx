...
export default function ContactHero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white py-24 lg:py-32 overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="text-center">
          ...
          >
            <div className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
              ...
              <p className="text-blue-100 text-sm">hello@xolace.com</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
            ...
            <div className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
              ...
              <p className="text-blue-100 text-sm text-center">San Francisco, CA</p>
            </div>
          </motion.div>
        </div>
      </div>
