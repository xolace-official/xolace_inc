              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-50/90 mb-1">media@xolace.com</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-50/90 mb-1">+1 (555) 123-4567</p>
                    <p className="text-sm text-gray-50/70">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-50/90 mb-1">
                      Maya Johnson, Media Relations Director
                    </p>
                    <p className="text-sm text-gray-50/70">
...
function CrisisResources() {
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-br from-teal-900 via-slate-900 to-cyan-900">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        <div className="p-8 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
